...
export class NodeGeometry {
     ...
     */
    serialize(saveMeshData, selectedBlocks) {
...
NodeGeometry.EditorURL = `https://unpkg.com/babylonjs-node-geometry-editor@${Engine.Version}/babylon.nodeGeometryEditor.js`;
